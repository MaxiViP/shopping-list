<template>
	...
	>
		<div class="flex items-center justify-between">
			...
			<!-- ПРАВАЯ ЧАСТЬ: Кнопки и информация пользователя -->
...
/* Плавная анимация для логотипа */
img {
	transition: all 0.3s ease;
}

/* Увеличиваем логотип на очень маленьких экранах */
@media (max-width: 419px) {
	img {
		transform: scale(1.1);
	}
...
/* Минимальная ширина для текста при скрытом хедере */
.min-w-0 {
	min-width: 0;
}
</style>
